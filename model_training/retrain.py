...
def dummy__get_or_create_bottlenecks(*args):
    print(args)
...
def get_random_cached_bottlenecks(how_many):
  imageWrappers = LabelReader(directory, labelDir)[category]()
  def randomChoice(imageWrappers):
      raise NotImplementedError()
  return randomChoice(imageWrappers, how_many)
